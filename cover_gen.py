...
def add_text_to_image(input_path, output_path):
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                font_h4 = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSefif-Bold.ttf", int(height * 0.017))
            except:
    ...
    text_h4 = "Ebook made by:\nwww.github.com/LovelyCobra"
    ...
    def draw_text_with_bg(text, font, position, text_color, bg_color=None, bg_padding=10):
        nonlocal draw, img  # Allow modification of outer scope variables
        ...
        draw.text((width//2, height-50), text, font=font, fill=text_color, anchor='mm')
...
if __name__ == "__main__":
    input_path = 'Russ_suttas/Маджхима Никая.png'
    output_path = 'Russ_suttas/Маджхима_Никая_.png'
